...
// ================= DASHBOARD E GRÁFICOS (RECONSTRUÍDO E BLINDADO) ================= //
...
function gerarGraficosDash(dadosVendas) {
    ...
    // Tenta encontrar o canvas antigo das lojas para limpar, senao recria seguro
    ...
    // Recria seguro também (para a pizza a altura importava, vamos recriar o wrap)
